...
class Inventory:
    ...
    def add_loot(self):
        ...
        self.image_stop_cloc = ObjectPath.TimeStopClock
        self.Tima_Stop_clock = pygame.image.load(self.image_stop_cloc)
        self.Tima_Stop_clock_scale = pygame.transform.scale(self.Tima_Stop_clock, self.size_mesh_inventory_Ak)
